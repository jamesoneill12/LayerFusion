...
from loaders.cv import known_models, select
from models.networks.compress.quantize import quant
import torch
...
parser.add_argument('--type', default='cifar10', help='|'.join(known_models))
...
parser.add_argument('--model_root', default='~/.torch/mods/', help='folder to save the model')
...
model_raw, ds_fetcher, is_imagenet = select(args.type, model_root=args.model_root)
