...
class GORUCell(nn.Module):
    ...
    def reset_parameters(self):
        ...
        init.orthogonal_(self.gate_U.data)
        ...
        init.constant_(self.gate_bias.data, val=0)
    ...
    def forward(self, input_, hx):
        ...
        r, z = torch.split(gate_Ux + gate_Wh, self.hidden_size, dim=1)
...
class GORU(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layer, cell_class=GORUCell, capacity=2, embedding=True,
