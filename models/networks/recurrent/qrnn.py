"""
Quantized RNN implementation
"""

import torch
from torch import nn
from torch.autograd import Variable
from models.networks.recurrent.forget_mult import ForgetMult
...
class QRNN(torch.nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size=None,
        ...
        self.layers = torch.nn.ModuleList(layers if layers else [QRNNLayer(input_size if l == 0
                                                                           else hidden_size, hidden_size, **kwargs)
    ...
    def forward(self, input, hidden=None):
        ...
        # print(input.size(), next_hidden.size())
        # this line added to decode to size of the vocabulary
        # input = self.out_linear(input)
