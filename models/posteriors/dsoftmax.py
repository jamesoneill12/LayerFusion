...
class DifferentiatedSoftmax(nn.Module):
    def __init__(self, ntokens, nhid, unigram_dist, paritions = 10, ntokens_per_class = None):
        super(DifferentiatedSoftmax, self).__init__()
...
if __name__ == "__main__":
    ...
    ntoken, nhid, ntokens_per_class = 100, 50, 100
    DifferentiatedSoftmax(ntoken, nhid, ntokens_per_class)
