import numpy as np
from models.networks.compress.prune.utils import\
    prune_rate, arg_nonzero_min, check_prune_perc, get_wc


def thresh_prune(rnn, threshold):
    ...
    for p in rnn.parameters():
        ...
        # count += 1
    return pruned_inds_by_layer, weight_tensors0, weight_tensors1
...
def weight_prune(model, pruning_perc, return_masks=False, all_weights = False):
    ...
    pruning_perc = check_prune_perc(pruning_perc)
