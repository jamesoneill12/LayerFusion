...
"""Useful for testing whether byte pair encoding can be used as a latent variable approach to neural langage model -
    Idea: Predict byte pair symbols instead of words, it lands somewhere between character and word level LMs
...
class BytePairEncoder:
    ...
    def from_dict(cls, vocabs):
        ...
        encoder = BytePairEncoder(**vocabs['kwargs'])
