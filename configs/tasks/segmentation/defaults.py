...
_C = CN()
_C.CONFIG_ROOT = "C:/Users/jamesoneill/Projects/NLP/GOLM/" \
                 "golm/golm/golm_hil/configs/tasks/segmentation/"
_C.MODEL_ROOT = "D:/data/ade20k/ADEChallengeData2016/pretrained_models/"
_C.DIR = _C.MODEL_ROOT + "baseline-resnet50dilated-ppm_deepsup/"

# -----------------------------------------------------------------------------
# Dataset
# -----------------------------------------------------------------------------
_C.DATASET = CN()
_C.DATASET.root_dataset = "D:/data/ade20k/"
_C.DATASET.list_train = "D:/data/ade20k/training.odgt"
_C.DATASET.list_val = "D:/data/ade20k/validation.odgt"
